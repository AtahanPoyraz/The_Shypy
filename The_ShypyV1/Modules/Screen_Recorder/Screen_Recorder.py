...
class Screen_Recorder():
    ...
    def ended(self, name):
        ...
        clear_terminal()
        if platform.system() == "Windows":
            print(f"[!] Screen Recorder Was Created On this Location: {dist_folder}\dist\{exe_location} ")      
        else:
            print(f"[!] Screen Recorder Was Created On this Location: {dist_folder}/dist/{exe_location} ")
